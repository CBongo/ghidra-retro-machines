...
/**
 * Fixed-length C64 screen-code string, hardwired to the {@code x-c64-screencode-shifted}
...
public class ScreencodeShiftedStringDataType extends AbstractStringDataType {
	...
	public ScreencodeShiftedStringDataType(DataTypeManager dtm) {
		super("ScreencodeShiftedString", // data type name
			...
			"SCSTRS", // default label prefix
			"scs", // default abbrev label prefix
			"C64 Screen-code String (fixed length, shifted)", // description
			"x-c64-screencode-shifted", // charset
	...
	public DataType clone(DataTypeManager dtm) {
		...
		return new ScreencodeShiftedStringDataType(dtm);
	}
}
